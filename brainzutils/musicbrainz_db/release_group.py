...
def get_release_group_by_id(mbid, includes=None, suppress_no_data_found=False):
...
def fetch_multiple_release_groups(mbids, includes=None, suppress_no_data_found=False):
