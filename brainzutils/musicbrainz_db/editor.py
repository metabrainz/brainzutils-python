...
def get_editor_by_id(editor_id, includes=None, suppress_no_data_found=False):
...
def fetch_multiple_editors(editor_ids, includes=None, suppress_no_data_found=False):
